...
class mapFigure(go.Figure):
    ...
    def __init__(self, # дефолтные параметры plotly
        data=None, layout=None, frames=None, skip_invalid=False, path_to_regions_parquet="map/russia_regions.parquet",
        **kwargs # аргументы (см. документацию к plotly.graph_objects.Figure())
        ...
        regions = pd.read_parquet(path_to_regions_parquet)
        # прорисовка регионов
