...
def find_common_groups(parser: Parser, path_to_file: str):
    ...
    parser.save_counter(path_to_file='output_data/counter_end.csv')
...
def test(parser: Parser):
    parser.set_users([378256, 678560])
    parser.parse_user_info(n_users='all')
    print(parser.df)
...
if __name__ == '__main__':
    ...
    #get_top_common_groups(parser, save_file = False)
    #get_top_groups_types(parser)
